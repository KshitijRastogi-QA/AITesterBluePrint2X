...
8. Derive the output filename from the JIRA story ID, title, and timestamp:
   - Format: `{JIRA-ID}-{kebab-case-story-title}-{YYYYMMDDHHmmss}.md`
   - Example: `PROJ-1234-login-dashboard-test-plan-20260405143022.md`
   - Use current UTC timestamp in YYYYMMDDHHmmss format to ensure uniqueness
9. Save the final test plan to:
   `output/test-plan/{JIRA-ID}-{kebab-case-story-title}-{YYYYMMDDHHmmss}.md`
10. Confirm to the user: 
    "✅ Test plan generated and saved to 
    output/test-plan/{filename}.md" (with timestamp included in the filename)
